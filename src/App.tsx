  ...
  return (
    <Routes>
      ...
      <Route
        ...
        element={<GiftCreateTogetherPage />}
      />
      ...
      <Route
        path="/group/:id/candidates/:candidateId"
        element={<CandidateDetailPage />}
      />
      <Route
        path="/group/:id/candidates/:candidateId/comments"
        element={<CandidateCommentsPage />}
      />
      <Route path="/group/:id/candidates/new" element={<CandidateNewPage />} />
      <Route path="/group/:id/participants" element={<ParticipantViewPage />} />
      <Route
        path="/group/:id/participants/manage"
      ...
      <Route
        path="/group/:id/edit/account"
        element={<GroupEditAccountPage />}
      />
      <Route
        path="/group/:id/edit/invitation"
        element={<GroupEditInvitationPage />}
      />
      <Route
        path="/group/:id/purchase-upload"
        element={<PurchaseUploadPage />}
      />
