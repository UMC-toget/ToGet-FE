...
export default function ConfirmEditPage() {
  ...
  const backToEdit = {
    // 확정 선물을 추가하는 진입이라 CandidateNewPage 문구를 '후보' 대신 '선물' 버전으로 띄운다
    giftMode: true,
    returnTo: `/group/${id}/confirm/edit`,
    returnState: { ...passedState, confirmedGifts: gifts },
  }
  ...
  return (
    <div className="mx-auto flex min-h-dvh w-full max-w-[402px] flex-col bg-white">
      <Header title="선물 목록 수정하기" onBack={() => setShowExitModal(true)} />
