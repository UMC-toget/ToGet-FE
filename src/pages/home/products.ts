...
/** '요즘 인기'는 특정 상황(occasion) 태그가 아니라 전체를 인기순으로 보여주는 탭이라 상품별 occasion 태그에서 제외합니다 */
export type ProductOccasion = Exclude<(typeof GIFT_CATEGORIES)[number], '요즘 인기'>
...
export const MOCK_PRODUCTS: Product[] = [
  { id: 1, brand: '입생로랑', name: '[향수1.2ML증정] 캔디글로우 립밤', price: 49000, image: productLipbalm, occasion: '생일' },
  { id: 2, brand: '오쏘몰', name: '이뮨 멀티비타민 &미네랄 7입', price: 43000, image: productVitamin, occasion: '졸업' },
  { id: 3, brand: '부이', name: '부이 Y2K 디지털 카메라', price: 42900, image: productCamera, occasion: '생일' },
  { id: 4, brand: '이솝', name: '콤팩트 룸 스프레이', price: 47000, image: productRoomspray, occasion: '집들이' },
  {
    id: 5,
    brand: '헤라',
    name: "[각인] 블랙 쿠션 파운데이션 '싱글' 본품1 + 증정",
    price: 46800,
  ...
  },
  {
    id: 7,
    brand: '탬버린즈',
    name: '[선물포장] BEST 미니 퍼퓸 핸드크림 (신규향 단독 런칭)',
    price: 18500,
    image: productHandcream,
    occasion: '집들이',
  },
  { id: 8, brand: '오브리', name: '오브리 도트 머쉬룸 램프 화이트', price: 65000, image: productLamp, occasion: '집들이' },
]
